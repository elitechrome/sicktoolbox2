...
#include <cstdio>
#include <math.h>
#include <sicktoolbox2/SickLMS5xx.hh>
#include "ros/ros.h"
...
int main(int argc, char **argv)
{
    ...
    nh_ns.param<std::string>("ip_add", ip_add, "192.168.0.71");
    nh_ns.param<std::string> ("frame_id", frame_id, "laser");
    nh_ns.param<bool> ("slam_flag", flagSlam, false);
    ...
    try {
        ...
        sick_lms.SetSickEchoFilter(SickLMS5xx::SICK_LMS_5XX_ECHO_FILTER_LAST);
        sick_lms.SetSickScanDataFormat(SickLMS5xx::SICK_LMS_5XX_SCAN_FORMAT_DIST_REFLECT);
    ...
    //if (!flagSlam)
    //{
        sick_lms.SetSickScanFreqAndRes(SickLMS5xx::SICK_LMS_5XX_SCAN_FREQ_25, SickLMS5xx::SICK_LMS_5XX_SCAN_RES_17);
    //}
    //else
    //{
    //    sick_lms.SetSickScanFreqAndRes(SickLMS5xx::SICK_LMS_5XX_SCAN_FREQ_100, SickLMS5xx::SICK_LMS_5XX_SCAN_RES_67);
    //}
    ...
    try {
		...
		while(ros::ok()) {
            ...
            sick_lms.GetSickMeasurements(range_values, NULL, NULL, NULL, NULL,
                                         intensity_values, NULL, NULL, NULL, NULL,
			                             n_range_values);
            n_intensity_values = n_range_values;
